...
# Aproximadamente 10% da base total
TAMANHO_AMOSTRA = 2_100_000
...
def main():
    ...
    print("\n" + "=" * 80)
    print("XGBOOST V2 - PREVISÃO DE AUSÊNCIA NO ENEM")
    print("=" * 80)
    ...
    try:
        ...
        print(
            "Essa amostra corresponde a aproximadamente "
            "10% da base total."
        )

        # ----------------------------------------------------
        # MONTAR COLUNAS DO SELECT
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
        # VERIFICAR COMO FAZER A ORDENAÇÃO
        # ----------------------------------------------------
        ...
        if "NU_INSCRICAO" in colunas_banco:
            ...
            # Define uma semente para que a seleção
            # aleatória seja reproduzível
            cursor.execute(
                "SELECT setseed(0.42);"
            )
        ...
        # Converte o objeto SQL para texto
        ...
        print(
            "O treinamento pode levar alguns "
            "minutos devido ao tamanho da amostra."
        )
        ...
        print("\n" + "=" * 80)
        print("CONCLUSÃO DO XGBOOST V2")
        print("=" * 80)

        print(
            f"\nO XGBoost V2 apresentou Recall de "
        ...
        print(
            "\nO XGBoost V2 utiliza uma amostra maior "
            "que a versão V1, permitindo avaliar o efeito "
            "do aumento da quantidade de dados no modelo."
        )

        print(
            "\nOs resultados serão comparados com o "
            "baseline, Random Forest e XGBoost V1."
        )
...
# XGBoost V2:
# treinado utilizando uma amostra de 2.100.000 registros
# da base tratada, aproximadamente 10% da base total.
#
# Foram utilizados 80% dos dados para treinamento
# e 20% para teste.
#
