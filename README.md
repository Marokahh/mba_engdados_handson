...
Entre os dados de interesse estão:

- Situação de presença ou ausência;
...
Os dados utilizados são provenientes de bases públicas oficiais e serão utilizados para fins acadêmicos e de análise.
